  ...
  return (
    <div className={styles.services}>
        <p className={styles.siteDescription}>
            元山 (<a href="https://twitter.com/kudakurage">@kudakurage</a>) と出口 (<a href="https://twitter.com/dex1t">@dex1t</a>) が最近気になっているサービスやデザイントピックスを取り上げてのんびり話すPodcastです。毎週金曜日に配信します。<br/>
            感想や質問などは、Twitterでハッシュタグ <a href="https://twitter.com/search?q=%23resizefm">#resizefm</a> をご利用ください。
        </p>
        <div className={styles.buttons}>
            ...
            <a href="https://open.spotify.com/show/7A4HxFxQ2Kr4pyJ0e3VEYj" className={styles.buttonItem}>
